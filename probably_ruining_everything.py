...
class isothermalISM(object):
    ...
    def timestep(self,dt,mbal):
        ...
        B[self.nn-1] = self.bed[self.nn-1] #s       
        ...
        #self.elev[self.nn-1] = self.elev[self.nn-2]
...
run1 = isothermalISM(55, 1000, 1e-16, .0001) #550 nodes, 100-meter spacing, glen's A (fixed), basal slip of zero
